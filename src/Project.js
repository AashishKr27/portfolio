      ...
      <div data-aos="fade-up" className="project-list">
        ...
        <div data-aos="fade-up" className="project-card">
          ...
          <div className="project-content">
            <h3>Brainwave</h3>
            <p>
              Modern UI/UX website, developed using React Js, Vite Js and
              Tailwind CSS
            </p>
            <a
        ...
        <div data-aos="fade-up" className="project-card">
          ...
          <div className="project-content">
            <h3>SnapGram</h3>
            <p>
              Fully functional social media application using React Js, Tailwind
              CSS
            </p>
            <a
        ...
        <div data-aos="fade-up" className="project-card">
          ...
          <div className="project-content">
            <h3>Apple Webpage</h3>
            <p>
              Designed an animated and attractive webpage for presenting the
              Apple iPhone 15 Pro
            </p>
            <a
        ...
        <div data-aos="fade-up" className="project-card">
          ...
          <div className="project-content">
            <h3>Portfolio</h3>
            <p>
              Portfolio website to showcase my development & problem solving
              skills
            </p>
        ...
        <div data-aos="fade-up" className="project-card">
          ...
          <div className="project-content">
            <h3>Amazon Clone</h3>
            <p>
              Created a clone website of frontend of Amazon using JavaScript,
        ...
        <div data-aos="fade-up" className="project-card">
          <img className="project-image" src={hotel} alt="imag" />
          <div className="project-content">
            <h3>Geritch</h3>
            <p>
              Created a simple and attractive Restaurant Webpage using JavaScript,
              React Js,  CSS
            </p>
            <a
              href="https://restaurant-webpage-bice.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              View Project
          ...
          <>
            <div data-aos="fade-up" className="project-card">
              ...
              <div className="project-content">
                <h3>Dev Landing</h3>
                <p>
                  Created a simple and attractive landing page using JavaScript,
            ...
            <div data-aos="fade-up" className="project-card">
              ...
              <div className="project-content">
                <h3>Spotify Clone</h3>
                <p>
                  Designed a clone website of Spotify with preloaded songs using
                  React Js, Vite Js, Tailwind CSS
                </p>
                <a
            ...
            <div data-aos="fade-up" className="project-card">
              ...
              <div className="project-content">
                <h3>Weather App</h3>
                <p>
                  Created a real-time weather application using JavaScript,
                  React Js, Tailwind CSS
                </p>
                <a
                  href="https://react-weather-app-iota-orpin.vercel.app/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  View Project
            ...
            <div data-aos="fade-up" className="project-card">
              ...
              <div className="project-content">
                ...
                <p>
                  An application for converting speech into text using
                  JavaScript, React Js, CSS
                </p>
                <a
                  href="https://speech-to-text-convertor-fawn.vercel.app/it"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  View Project
            ...
            <div data-aos="fade-up" className="project-card">
              ...
              <div className="project-content">
                ...
                <p>
                  Implemented a Machine Learning Model for prediciting Fake News
                  using Python
                </p>
                <a
            ...
            <div data-aos="fade-up" className="project-card">
              ...
              <div className="project-content">
                ...
                <p>
                  Implemented a Machine Learning Model for prediciting Diabetes
                  using Python
                </p>
                <a
            ...
            <div data-aos="fade-up" className="project-card">
              ...
              <div className="project-content">
                ...
                <p>
                  Implemented a Machine Learning Model for prediciting House
                  Price using Python
                </p>
                <a
            ...
            <div data-aos="fade-up" className="project-card">
              ...
              <div className="project-content">
                ...
                <p>
                  Implemented a Machine Learning Model for prediciting Loan
                  Status using Python
                </p>
                <a
                  href="https://github.com/AashishKr27/Loan-Status-Prediction-Using-ML"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  View Project
            ...
            <div data-aos="fade-up" className="project-card">
              ...
              <div className="project-content">
                ...
                <p>
                  Implemented a Machine Learning Model for prediciting Wine
                  Quality using Python
                </p>
                <a
                  href="https://github.com/AashishKr27/Wine-Quality-Prediction-Using-ML"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  View Project
            ...
            <div data-aos="fade-up" className="project-card">
              ...
              <div className="project-content">
                ...
                <p>
                  Implemented a Machine Learning Model for prediciting Sonar
                  Rock & Mine using Python
                </p>
                <a
            ...
            <div data-aos="fade-up" className="project-card">
              ...
              <div className="project-content">
                ...
                <p>
                  Implemented a Machine Learning Model for Customer Segmentation
                  using Python
                </p>
                <a
                  href="https://github.com/AashishKr27/Customer-Segmentation-Using-ML"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  View Project
